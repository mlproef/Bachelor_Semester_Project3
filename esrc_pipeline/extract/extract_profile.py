...
Ported from esrc_stas/extract.py — algorithm only, no pool_en/HN paths.
"""
...
class ExtractResult:
    ...
    chunked: bool
    n_chunks: int
    method: str  # single | planned_chunks | recursive_fallback | empty
...
def extract_profile(
    ...
    *,
    ...
    """Run conditional Extract (single or chunk-and-merge) on one profile."""
