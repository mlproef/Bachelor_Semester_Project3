#!/usr/bin/env python3
"""Run ESRC Reason for Condition B.

Needs::
  results/b/extract/query/*.txt
  results/b/extract/candidates/*.txt
  results/b/search/search_top15.csv

Writes::
  results/b/reason/reason_predictions.jsonl
  results/b/reason/reason_metrics.json

Usage:
  python esrc_pipeline/scripts/run_reason_b.py --dry-run --limit-queries 2
  python esrc_pipeline/scripts/run_reason_b.py
"""
...
def main() -> None:
    ...
    p.add_argument(
        ...
        default=None,
        help="Whose candidate extracts to pick from (default: B)",
    )
    args = p.parse_args()
