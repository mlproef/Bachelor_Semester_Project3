#!/usr/bin/env python3
"""Run ESRC Reason for So2 control A vs a candidate gallery.

Needs::
  results/so2_a/extract/query/*.txt
  results/baseline/extract/candidates/*.txt
  results/so2_a/search_vs_baseline/search_top15.csv

Writes::
  results/so2_a/reason_vs_baseline/reason_predictions.jsonl

Usage:
  python esrc_pipeline/scripts_so2/run_reason_a.py --dry-run --limit-queries 2
  python esrc_pipeline/scripts_so2/run_reason_a.py --gallery-condition baseline
"""
