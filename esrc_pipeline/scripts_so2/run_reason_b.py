#!/usr/bin/env python3
"""Run ESRC Reason for So2 control B vs a candidate gallery.

Needs::
  results/so2_b/extract/query/*.txt
  results/baseline/extract/candidates/*.txt
  results/so2_b/search_vs_baseline/search_top15.csv

Writes::
  results/so2_b/reason_vs_baseline/reason_predictions.jsonl

Usage:
  python esrc_pipeline/scripts_so2/run_reason_b.py --dry-run --limit-queries 2
  python esrc_pipeline/scripts_so2/run_reason_b.py --gallery-condition baseline
"""
