#!/usr/bin/env python3
"""Run ESRC Search for So2 control B vs a candidate gallery.

Needs Extract::
  esrc_pipeline/results/so2_b/extract/query/*.txt

One-sided default (control queries vs raw candidates)::
  python esrc_pipeline/scripts_so2/run_search_b.py --gallery-condition baseline

Writes::
  esrc_pipeline/results/so2_b/search_vs_baseline/search_top15.csv
"""
