#!/usr/bin/env python3
"""Run ESRC Search for So2 control C vs a candidate gallery.

Needs Extract::
  esrc_pipeline/results/so2_c/extract/query/*.txt

One-sided default (control queries vs raw candidates)::
  python esrc_pipeline/scripts_so2/run_search_c.py --gallery-condition baseline

Writes::
  esrc_pipeline/results/so2_c/search_vs_baseline/search_top15.csv
"""
